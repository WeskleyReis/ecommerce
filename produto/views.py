    ...
    def get(self, *args, **kwargs):
        ...
        if variacao_id in carrinho:
            ...
            if variacao_estoque < quantidade_carrinho:
                messages.warning(self.request, f'Estoque insuficiente para {quantidade_carrinho}x no produto "{produto_nome}". Adicionamos {variacao_estoque}x no seu carrinho.')
        ...
        messages.success(
            self.request,
            f'Produto {produto_nome} {variacao_nome} adicionando no seu carrinho {carrinho[variacao_id]["quantidade"]}x.'
        )
